...
Tue 30/06: Akeef set up Google Docs document to start work on user stories, while waiting for gitlab to become available. Both drafted and edited Epic Stories in Google Doc.

Wed 01/07: Both tested running project starter code to make sure both group members' personal computers were setup to run the program correctly. Both familiarised with each other's experience in the areas addressed by this course. Akeef drafted most User Stories in the Google Doc.

### Week-06

Sat 11/07: Alex heavily edited and refined all user stories in Google Doc, and added any missing stories.

Mon 13/07: Alex moved and reformatted all epic and user stories to group Gitlab Issue Board. Akeef reviewed all stories and made further edits as necessary.
